...
/*
  Simplified division-level outline of Bangladesh.
  Path data adapted from the free/open "map-of-bangladesh" project
  by Nazmul Ahsan (github.com/mukto90/map-of-bangladesh) — used here only
  as a stylised, non-navigational illustration, not a precise GIS map.
  viewBox: 0 0 435 600
*/
...
const CITIES = [
  ...
  { id: "rajshahi", name: "রাজশাহী", trips: "৪৫+ ট্রিপ", x: 68, y: 158 },
  { id: "rangpur", name: "রংপুর", trips: "৩০+ ট্রিপ", x: 50, y: 48 }
];
